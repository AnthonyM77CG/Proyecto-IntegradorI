            ...
            <div id="details-content">
                <div id="vertical-image-container">
                    ...
                    // Obtener detalles de "El Padrino"
                                                                ...
                                                                Pelicula pelicula = metodos.getPeliculaPorNombre("La Matrix");
        ...
        <div class="combobox-row">
            <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("La Matrix");
           ...
           <div class="combobox-item">
            ...
            <div class="combobox-item">
                ...
                <select id="horario" name="horario">
                    ...
                    <%
                        List<String> listaHorarios = metodos.obtenerHorariosPorPelicula(2);
