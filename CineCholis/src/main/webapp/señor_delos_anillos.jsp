            ...
            <div id="details-content">
                <div id="vertical-image-container">
                    <%
                        ...
                        Pelicula pelicula = metodos.getPeliculaPorNombre("El Señor de los Anillos: La Comunidad del Anillo");
    ...
    <form action="dulceria.jsp" method="get">
        <div class="combobox-row">
            <div class="combobox-item">
                ...
                <select id="ciudad" name="ciudad">
                    ...
                    <%
                        List<String> listaCiudades = metodos.obtenerCiudadesPorPelicula("El Señor de los Anillos: La Comunidad del Anillo");
           ...
           <div class="combobox-item">
            ...
            <div class="combobox-item">
                ...
                <select id="horario" name="horario">
                    ...
                    <%
                        List<String> listaHorarios = metodos.obtenerHorariosPorPelicula(3);
       ...
       <script>
            ...
            function continuar() {
                ...
                var pelicula = "El Señor de los Anillos: La Comunidad del Anillo";
